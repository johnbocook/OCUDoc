...
<cfif isDefined("form.save")>
	...
	<cfif structKeyExists(form, "enclosureerror")>
		<cfset arrayAppend(errors, "Your attachment was removed because your session timed out. Please upload it again.")>
	</cfif>
...
<cfmodule template="../tags/adminlayout.cfm" title="Entry Editor">
	...
	<cfif not structKeyExists(form, "preview")>
		...
		<div class="ctrlHolder">
			...
			<br />
			<div id="btn-div" class="text-center">
				<a href="" id="uploadImage" class="btn btn-blue">Upload and Insert Image</a>
				<a href="" id="browseImage" class="btn btn-orange">Browse Image Library</a>
			</div>
		</div>
		</fieldset>
		<fieldset class="inlineLabels">		
		<div class="ctrlHolder">
			<label for="categories">Categories: <small class="small-block">Press CTRL + Click to select multiple categories.</small></label>
		...
		<fieldset class="inlineLabels" style="display:none;">				
		<div class="ctrlHolder">
		...
		<fieldset>
		<div class="ctrlHolder highlight-box">
			<label for="delete_enclosure">Attachments: </label>
			#listLast(form.oldenclosure,"/\")# <input type="submit" name="delete_enclosure" class="btn btn-red btn-delete" value="#application.resourceBundle.getResource("deleteenclosure")#">	
		</div>
		</fieldset>
		</cfif>
		</fieldset>
		...
		<div id="additional">	
			...
			<div class="ctrlHolder">
				<label for="released">Published: </label>
		...
		<div id="entry-btns">
			<input class="btn btn-green" type="submit" name="save" value="Save">
			<input class="btn" type="submit" name="preview" value="Preview">
			<input class="btn btn-red" type="submit" name="cancel" value="Cancel" onClick="return confirm('Are you sure you want to cancel this entry?')">  
		</div>
