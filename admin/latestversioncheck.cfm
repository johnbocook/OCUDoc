...
<cftry>
	...
	<cfif latestVersion neq application.blog.getVersion()>
		...
		<p>
		<b>Your application install may be out of the date!</b><br/>
		The latest released version is <b>#latestVersion#</b> updated on <b>#DateFormat(latestUpdate, 'long')#</b>.
		<p><b>Updates for this version include:</b></p>
		#latestDescription#
		</p>
		</cfoutput>
	<cfelse>
		<cfoutput><p>Your application is up to date!</p></cfoutput>
	</cfif>
	<cfcatch>
