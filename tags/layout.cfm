...
<head>
	...
	@import "#application.rooturl#/includes/styles/header-blue.css";
	@import "#application.rooturl#/includes/styles/content-default.css";
	@import "#application.rooturl#/includes/styles/side-blue.css";
	</style>
  ...
  <div id="header-wrap">
   <div id="header" class="block-content">
     <div id="pagetitle">
      ...
      <!-- /search form -->
      <p>#htmlEditFormat(application.blog.getProperty("blogDescription"))#</p>
     </div>
     ...
     <div id="nav-wrap1">
      <div id="nav-wrap2">
        <ul id="nav">
         ...
         <li><a href="#application.rooturl#/admin/" class="fadeThis"><span>Admin</span></a></li>
         <li><a href="#application.rooturl#/index.cfm?reinit=1" class="fadeThis"><span>Clear Cache</span></a></li>
         <li><a href="#application.rooturl#/admin/index.cfm?logout=youbetterbelieveit" class="fadeThis"><span>Logout</span></a></li>
...
<cfoutput>
 ...
 <div id="footer">
  <div class="block-content">
     <div class="copyright">
       <strong>OCU Docs</strong> by Ohio Christian University. Version #application.blog.getVersion()#
     </div>
  </div>
 </div>
 <!-- /footer -->
