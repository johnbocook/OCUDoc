...
dsn=blog
username=docs
password=3j~%>'$PpULd~GgW
owneremail=jbocook@ohiochristian.edu
blogURL=/docs/index.cfm
blogTitle=OCU Docs
blogDescription=Ohio Christian University Documentation
blogDBType=MSSQL
locale=en_US
users=
commentsFrom=
failTo=jbocook@ohiochristian.edu
mailserver=
mailusername=
mailpassword=
pingurls=
